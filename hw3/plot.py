...
plt.title('Performance vs. Threads for Different Sizes')
plt.legend()
plt.tight_layout()
...
plt.ylabel('Speedup')
plt.ylim(0, None)
plt.title('Speedup vs. Threads for Different Sizes')
plt.legend()
plt.tight_layout()
...
plt.ylim(0, None)
plt.title('Efficiency vs. Threads for Different Sizes')
plt.legend()
plt.tight_layout()
